      SUBROUTINE YINIT(Y,VL,IV,CENT,EINT,
     1                 N,MXLAM,NHAM,
...
C         BOUNDARY CONDITIONS
      ...
      DOUBLE PRECISION, INTENT(IN):: VL(*),ERED,R,EINT(N),
     &                               EP2RU,CM2RU,RSCALE,CENT(N)
      LOGICAL, INTENT(IN):: ZOUT
      INTEGER, INTENT(IN):: N,IV(*),MXLAM,NHAM,IPRINT
C  THE FOLLOWING ARRAYS ARE USED AS WORKSPACE AND VALUES RETURNED
C  ARE NOT USED
      DOUBLE PRECISION, ALLOCATABLE :: DIAG(:),EVAL(:),EVECS(:,:),
     1                                 W(:,:),P(:)
...
C  ADIAB MEANS INITIALISE IN DIABATIC BASIS
      ...
      ALLOCATE (W(N,N),DIAG(N),P(MXLAM+NCONST+NRSQ))
