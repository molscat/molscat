...
C  Distributed under the GNU General Public License, version 3
      USE potential, ONLY: NCONST, NEXBLK, NEXTMS, NEXTRA, NRSQ, NVLBLK
      IMPLICIT NONE
      INTEGER, INTENT(IN)    :: IPRINT,ITYPE,NLABV,LAM(*)
      INTEGER, INTENT(INOUT) :: MXLAM
      INTEGER, INTENT(OUT)   :: NHAM
C
C  CR Le Sueur/G McBane 09-10-18: REPLACED VERY SIMPLE CHECKING OF LAM
...
C
C  IT ALSO CHECKS THE ARRAY LAM OF POTENTIAL SYMMETRY INDICES
...
C            CONCEPTUALLY OF DIMENSION (NLABV,MXLAM).
