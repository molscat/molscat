...
C
      ...
      V=P3(B(2),2.D0*B(3),3.D0*B(4),R)
      GOTO 5000
 3100 T1=E(R)
      V=-2.D0*BETA*       T1*(T1-1.D0)
      GOTO 5000
 3200 RSQ=1.D0/(R*R)
      R6=RSQ*RSQ*RSQ/R
      V=       R6*(6.D0*C6+8.D0*C8*RSQ)
      GOTO 5000
 3400 RR=R*RMSAVE
      R12=R**(-12)
      RRT=RR+AC*R12
      V=-5.D0*RRT**(-6)*(1.D0-12.D0*AC*R12/RR)
      GOTO 5000
C * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
C
      ENTRY VSTAR2(I,R,V)
      ...
      V=P2(2.D0*B(3),6.D0*B(4),R)
      GOTO 5000
 4100 T1=E(R)
      V=T1*BETA*BETA*       (4.D0*T1-2.D0)
      GOTO 5000
 4200 RSQ=1.D0/(R*R)
      R6=RSQ*RSQ
      R6=R6*R6
      V=-       R6*(42.D0*C6+56.D0*C8*RSQ)
      GOTO 5000
 4400 RR=R*RMSAVE
      R12=R**(-12)
      RRT=RR+AC*R12
      XXX=1.D0-12.D0*AC*R12/RR
      V=-5.D0*RRT**(-6)*(156.D0*AC*R12/(RR*RR)-6.D0*XXX*XXX/RRT)
      GOTO 5000
C     * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
C
