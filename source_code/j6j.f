...
C
   ...
   16 SCALED=D6J(2)
      ...
      DO IJ2=3,INMID
        ...
        J1S=J1*J1
        E2=E(J1S)
        D6J(IJ2)=-(F1*D6J(IJ2-1)+J1*E1*D6J(IJ2-2))/(E2*(J1-ONE))
      ENDDO
      SCALED=D6J(INMID)
      IEXC=5
...
C
   30 D6J(IVAL)=HALF
      ...
      DO IJ2=2,IEND
        ...
        E1=E(J1S)
        F1=F(J1,JJP1)
        D6J(IVAL-IJ2)=-(J1*E2*D6J(IVAL-IJ2+2)+F1*D6J(IVAL-IJ2+1))/
     $                 (E1*(J1+ONE))
      ENDDO
C
