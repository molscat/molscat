      SUBROUTINE QAPROP(N,NSQ,MXLAM,NPOTL,
     1                  Y,T,U,VL,IV,EINT,CENT,P,
     2                  Q,W,EIVAL,Y1,Y2,Y3,Y4,
     3                  DIAG,RBEGIN,REND,NSTEPS,ERED,RMLMDA,
...
C
     ...
     1                   'R,VLAMBDA: ', R,(P(I)/RMLMDA,I=1,MIN(9,NPOTL))
        IF (IPRINT.GE.22) CALL MATPRN(6,W,N,N,N,0,W,' RMLMDA*(V-E)',1)
        IF (IPRINT.GE.24) CALL MATPRN(6,U,N,N,N,1,W,' EIGENVECTORS',1)
...
C
C  CODE TO CALCULATE MATRIX OF D/DR (NONADIABATIC COUPLINGS)
...
1000  FORMAT(/' ***** MATRIX INVERSION ERROR IN QAPROP AT ',
