...
C
  ...
  602 FORMAT('  ESTIMATES OF ENERGY ARE',3G22.14,1X,A)
     ...
     1                               GAM3/EFACT,UNAME
  603 FORMAT('  ESTIMATES OF WIDTH  ARE',3(7X,G11.4,4X),A)

      ENEXT=(ENEXT1+ENEXT2+ENEXT3)/3.D0
      GAM=(GAM1+GAM2+GAM3)/3.D0
      ESTEP=ABS(ENEXT-E(3))
      IF (IPRINT.GE.6) WRITE(6,604) ENEXT/EFACT,GAM/EFACT,UNAME
  604 FORMAT(/'  ESTIMATE RESONANCE ENERGY =',G22.14,'   WIDTH =',
     1       E11.4,1X,A)
      IF (KSAVE.GT.0) WRITE(KSAVE,610) CURV1,CURV2,CURV3,
     1                                 ENEXT/EFACT,GAM/EFACT,UNAME
  610 FORMAT('  *** CURVATURES',3G22.14,/'  *** GIVE ERES =',G22.14,
     1       '    GAM =',E11.4,1X,A)
