...
C
  ...
  602   FORMAT('  FINDRM: AT R =',F10.4,' SMALLEST REDUCED V-E IS',
     1            F11.2)
C
...
C
  ...
  603 FORMAT('  INNER CLASSICAL TURNING POINT AT R =',F10.4)
C
...
C
  ...
  606 FORMAT('  RADIAL PROPAGATION WILL START AT R =',F10.4)
      RETURN
C
