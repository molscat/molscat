...
C-------------------------------------------------------------------
  140   F14 = SS2/SSQ
     ...
     X                 )*2.D0
        R1V1 = HC*((-2.D0*SS2*F14+F15)*F40-
     1                 F16*(1.D0-DSQ*CON8*(1.D0-3.D0*F37)))
        R2V1 = HC*(-S2*CON4*(1.D0-F38*(1.D0-F37))+
     1               (0.5D0*C2-F14)/S*(1.D0-F16*(1.D0-F17)))*D
          GOTO 170
C-------------------------------------------------------------------
...
C-------------------------------------------------------------------
  160   F6 = XSXI*XSXI
        ...
        SSIJ = (R1V0-R1V1+R1V2-CXJ*(R2V0-R2V1+R2V2)-
     1                         CXI*(R2V0+R2V1+R2V2)+F7*(R1V0+R1V1+R1V2))
        CCJI = CCIJ
