...
C  VERSION OF 18 APRIL 94; FIXED NN=1 BUG 10 MAR 95 (SG)
      ...
      PARAMETER (MXIT=15, EPS=1.D-15, ROOTPI=SQRT(ACOS(-1.D0)))
      DIMENSION X(NN),A(NN)
C
...
C  COMPUTE GAMMA FN BY HASTINGS APPROX; 0.LE.X.LE.70.
  ...
  600     FORMAT('  *** GAUSHP. CANNOT GET GAMMA FUNCTION FOR',F10.2)
        ...
        ELSE
          ZA=1.D0
   10     Z=Z-1.D0
C  CRLS 06-2022: REPLACED ARITHMETIC IF
C         IF (Z-1.D0) 13,11,12
          IF (Z.EQ.1.D0) THEN
            GAMMA1=ZA
