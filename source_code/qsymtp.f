...
C  Distributed under the GNU General Public License, version 3
      ...
      INTEGER P1,Q1,P2,PP
C  THIS FUNCTION CALCULATES THE COUPLING COEFFICIENT FOR
C  CLOSE COUPLING BETWEEN A RIGID ROTOR AND AN ASYMMETRIC TOP (ITYP=4)
C
...
C
      PARAMETER (PI=3.14159265358979289D0)
