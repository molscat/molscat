...
C
      DATA ZERO /0.D0/ ,ONE /1.D0/, TWO /2.D0/, HALF /0.5D0/,
     1     ONPO /1.1D0/, MZERO /1.D-34/,TENTH /0.1D0/
C
...
C
   20 NMID=IVAL/2+1
      ...
      DO IM2=2,NMID
        J1=J1+TWO
        W3J(IM2)=-A(J1-ONE)*W3J(IM2-1)/A(J1)
      ENDDO
