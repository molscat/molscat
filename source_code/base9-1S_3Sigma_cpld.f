...
C  Distributed under the GNU General Public License, version 3
      ...
      USE basis_data, ONLY: ELEVEL, JHALF, JLEVEL, JMAX, JMIN, JSTEP,
     b                      NLEVEL, ROTI
      USE physical_constants, ONLY: bohr_magneton, g_e
...
C  USES THE NEW MECHANISM IN HAMMAT (AUG 06) TO HANDLE NON-DIAGONAL HINT
