     ...
     5                  LCURXS,LACCXS,ICHAN,NSIG,NFIELD,IBDX,CINT)
...
c     WRITE(6,*)'HAVE READ',JTOT,M,IFSET,INRG
     ...
     1            RXX(IXWV),RXX(IXSR),RXX(IXSI),X(ITKMAT),X(ITSCAT),
     2            CONV,NOPEN,M,MXPAR,WGHT,IEXCH,INRG,
     3            TTIME,ENERGX(INRG),EREF,SIGCUR,SIGACC(IACC),
     4            SIGDEG,JSTATE,ISST,IECONV,
     5            MINJT,MAXJT,NSTATE,NQN,OTOL,DTOL,
     6            0,ISIGU,IPARTU,ISAVEU,ISIGPR,IRSTRT,
     7            ICHAN,X(ITWK1),X(ITWK2),RXX(IXCENT),RXX(IXEINT),
     8            IBOUND,IXX(IXIUSE),IXX(IXIACC),IXX(IXLNEV),CINT,IFSET,
     9            JPRINT,.TRUE.,.FALSE.)
C
