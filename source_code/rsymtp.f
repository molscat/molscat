...
C  COUPLED STATES APPROXIMATION BETWEEN A RIGID ROTOR AND
C  AN ASYMMETRIC TOP (ITYP=24)
C
...
C            ALL UNCHANGED ON EXIT.
      ...
      INTEGER P1,Q1,P2,PP
      PARAMETER (Z0=0.D0, PI=3.14159265358979289D0)
C  INTERNAL FUNCTION...
      Z(X)=2.D0*X+1.D0
C
      XJ1 = J1
     ...
     1       *Z(XJJ)*Z(XJJP))*PARSGN(J1P+J2P+JJ+MU-K1)/(4.D0*PI)
      RETURN
      END
